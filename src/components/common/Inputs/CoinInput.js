...
import { setInputValue1, setInputValue2 } from "../../../redux/InputValues/inputValues";
          ...
          {tokenType === "tk1" ? (
            <Input
              ...
              value={tokenSwitch ? ((input1) / 10 ** 18).toLocaleString("fullwide", {
                useGrouping: !1,
              }) : Number(input2) ? (Number(input1) / 10 ** 18).toLocaleString("fullwide", {
                useGrouping: !1,
              }) : inputvalueOne}
            ...
            <Input
              placeholder={maximumValue ? Number(maximumValue).toFixed(2) : "0"}
              type="number"
              value={tokenSwitch ? (Number(input2) / 10 ** 18).toLocaleString("fullwide", {
                useGrouping: !1,
              }) : Number(input1) ? (Number(input2) / 10 ** 18).toLocaleString("fullwide", {
                useGrouping: !1,
              }) : inputvalueTwo}
