...
export const RemoveLiquidityETHWithPermitService = async (waddress, signature, calculatedLiquidity, tokenAmin, tokenBmin, customTokenAddress, deadLine) => {
    try {
        const {
            v,
            r,
        ...
        if (contract) {
            ...
            gasLimit = await contract.methods.removeLiquidityETHWithPermit(
...
export const RemoveLiquidityWithPermitService = async (waddress, signature, calculatedLiquidity, tokenAmin, tokenBmin, tokenAaddress, tokenBaddress, deadLine) => {
    try {
        ...
        if (contract) {
            ...
            gasLimit = await contract.methods.removeLiquidityWithPermit(
                tokenAaddress,
                tokenBaddress,
                calculatedLiquidity,
                tokenAmin,
...
export const getRemoveLiquiditySignature = async (waddress, pairAddress, liquidity, deadline) => {
    const router = uniswapContractsInfo.filter((a) => a.symbol === "ROUTER");
