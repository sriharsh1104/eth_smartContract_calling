...
import { setLowPrice, setMediumPrice, setHighPrice, setuserSelectedPrice } from "../../../../../redux/Gasprices/GasPrice";
...
const SwapSetting = (props) => {
  ...
  const fetchData = async () => {
    ...
    // console.log("resssaqwerty",result);
    dispatch(setMediumPrice(result.data.average / 10))
    // console.log("resssaqwerty",result.data.fastest/10);
